...
def load_model():
    config_class, model_class, tokenizer_class = AlbertConfig, AlbertForTokenClassification, AlbertTokenizer
    global tokenizer
...
if __name__ == '__main__':
    ...
    print("Model loaded")
    #app.debug = True
    app.run(threaded=False, host='0.0.0.0', port=5002)
